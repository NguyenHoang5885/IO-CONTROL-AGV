...
#define BNO_EN_Pin GPIO_PIN_12
#define BNO_EN_GPIO_Port GPIOE
#define BNO_PS1_Pin GPIO_PIN_13
#define BNO_PS1_GPIO_Port GPIOE
#define BNO_PS2_Pin GPIO_PIN_14
#define BNO_PS2_GPIO_Port GPIOE
