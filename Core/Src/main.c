...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GND_OUT_9_Pin|GND_OUT_10_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : VCC_OUT_9_Pin */
  GPIO_InitStruct.Pin = VCC_OUT_9_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(VCC_OUT_9_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : GND_OUT_9_Pin VCC_OUT_10_Pin GND_OUT_10_Pin */
  GPIO_InitStruct.Pin = GND_OUT_9_Pin|VCC_OUT_10_Pin|GND_OUT_10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
